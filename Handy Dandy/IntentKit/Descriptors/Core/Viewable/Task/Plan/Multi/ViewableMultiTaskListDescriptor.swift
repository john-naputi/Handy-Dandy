...
#Preview {
    let plan = Plan(title: "Test", description: "Plan Description", planDate: .now, tasks: [
        ChecklistTask(title: "First Task", description: "First Task Description"),
        ChecklistTask(title: "Second Task", description: "Second Task Description"),
        ChecklistTask(title: "Third Task", description: "Third Task Description")
    ])
